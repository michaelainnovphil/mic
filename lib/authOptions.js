...
export const authOptions = {
  providers: [
    AzureADProvider({
      ...
      authorization: {
        params: {
          // ✅ Keep all required scopes here
          scope: "openid profile email offline_access User.Read.All GroupMember.Read.All TeamMember.Read.All AuditLog.Read.All",
        },
      },
    }),
  ],
...
async function refreshAccessToken(token) {
  try {
    ...
    params.append(
      "scope",
      "openid profile email offline_access User.Read.All GroupMember.Read.All TeamMember.Read.All Presence.Read.All"
    );
